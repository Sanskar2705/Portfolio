...
const researchProjects = [
  ...
  },
  {
    ...
    tagline: 'Predicting Candidate Fidelity Without Query-Time Exact kNN Reference · Preparing for VLDB',
    icon: Cpu,
    badge: 'VLDB (Target Oct 2026) · [IN PREPARATION]',
    badgeType: 'purple',
    description: 'Predicting approximate retrieval quality without ground-truth queries through offline-constructed landmark spaces. We propose surrogate rankers enabling zero-cost-at-query-time quality estimation viable across architectures and modalities, with applicability to dynamic index selection and cost-aware retrieval planning.',
    tags: ['Vector Databases', 'ANN Indexing', 'Candidate Fidelity', 'HNSW', 'IVFPQ'],
    isConfidential: true,
    confidentialNotice: 'Preparing for VLDB Submission (October 2026) · Manuscript in Preparation',
  },
  {
    id: 'eduexplain',
    title: 'EduExplain: A Benchmark for Multimodal Explanation Set Retrieval from Educational Resources',
    tagline: 'First Dedicated Benchmark for Coherent Multimodal Explanations in Education',
    icon: BookOpen,
    badge: 'ACM SIGIR-AP \'26 · [UNDER REVIEW]',
    badgeType: 'amber',
    description: 'Addressing explanation-level relevance assessment in knowledge domains by introducing the first curated benchmark for retrieving grounded explanatory content. We reveal that in educational settings, precision and topical coherence dominate diversity considerations, with implications for rank-based set selection.',
    tags: ['Educational IR', 'Set Retrieval', 'Multimodal Explanations', 'Benchmark Dataset'],
    isConfidential: true,
    confidentialNotice: 'Submitted July 2026 to ACM SIGIR-AP 2026 · Double-Blind Peer Review',
  },
  {
    id: 'mmir-explorer',
