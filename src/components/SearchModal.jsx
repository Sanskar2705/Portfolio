...
const searchItems = [
  ...
  { type: 'Section', title: 'Selected Publications', subtitle: 'Accepted papers at CIKM 2026, ECIR 2027 (under review), and workshops', target: 'publications' },
        ...
        <div className="search-footer">
          <div className="search-footer-left">
            <a href="https://info.flagcounter.com/3KjK" target="_blank" rel="noopener noreferrer" title="View detailed visitor stats">
              <img 
                src={`https://s01.flagcounter.com/count2/3KjK/bg_08090d/txt_f8fafc/border_1e2230/columns_2/maxflags_6/viewers_0/labels_1/pageviews_1/flags_0/percent_0/?t=${Date.now()}`} 
                alt="Visitor Stats" 
